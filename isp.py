...
Suppose we have an interface called PaymentProcessor that defines methods for processing payments and refunds. 
...
Redesign this program to follow the  Interface Segregation Principle (ISP) principle which represents that 
...
class ProcessBoth(PaymentProcessor,RefundProcessor):
    def process_payment(self, amount):
